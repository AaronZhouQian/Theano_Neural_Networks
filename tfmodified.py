...
def train_lstm(
    ...
    print('Loading data')
    train, valid, test = load_data(n_words=n_words, valid_portion=0.05, maxlen=100)
    ...
    try:
        for eidx in range(max_epochs):
            ...
            for _, train_index in kf:
                ...
                print(zip(( range(len(list(train_index))), list(train_index)  )))
                print("training error:")
                print(pred_error(f_pred, prepare_data, train, zip(( range(len(list(train_index))), list(train_index)  ) ) ) )
